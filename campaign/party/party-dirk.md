...
|-----|-----|-----|-----|-----|-----|
| 13 (+1) | 19 (+4) | 15 (+2) | 10 (+0) | 10 (+0) | 8 (−1) |

**HP:** 38 | **AC:** 16 (*Mariner's Studded Leather* — magic armor, worn) | **Speed:** 30 ft. walking, 30 ft. climbing, 30 ft. swimming *(while wearing the Mariner's armor)* | **Initiative:** +4
**Proficiency Bonus:** +3 | **Hit Dice:** 5d8
**Saving Throws (prof):** Dexterity +7, Intelligence +3
**Passive Perception:** 13 | **Passive Insight:** 13 | **Passive Investigation:** 13
**Senses:** Darkvision 120 ft.
**Currency:** 58 gp

### Key Skills (proficient/expertise)
Sleight of Hand +10 *(expertise)*, Stealth +10 *(expertise)*, Acrobatics +7, Insight +3, Investigation +3, Perception +3

### Weapons
| Name | Hit | Damage |
|------|-----|--------|
| Shortsword, +1 | +8 | 1d6+5 Piercing *(Finesse, Light, Vex)* |
| Shortbow | +7 | 1d6+4 Piercing *(Vex; range 80/320)* |
| Dagger (×2) | +7 | 1d4+4 Piercing *(Finesse, Light, Thrown 20/60; Nick)* |
| Enhanced Unarmed Strike | +4 | 1d4+1 Bludgeoning *(Tavern Brawler)* |

### Magic Items
- **Mariner's Studded Leather Armor** *(uncommon, no attunement)* — AC 12 + DEX; while worn, Dirk has a **swimming speed equal to his walking speed**, and if he starts a turn underwater at 0 HP he rises 60 ft. toward the surface. Very on-brand for a sailor.
- **Shortsword, +1** *(uncommon)* — +1 to attack and damage (included in the table above).

### Features & Traits
- **Sneak Attack:** 3d6 extra damage (once per turn, advantage or flanking ally; Finesse/Ranged weapon)
- **Cunning Action:** Dash, Disengage, or Hide as bonus action
- **Steady Aim:** Bonus action, advantage on next attack this turn (Speed 0 if used; must not have moved)
...
- **Cunning Strike:** Add effects to Sneak Attack (costs Sneak Attack dice):
  - Poison (1d6, DC 15 CON — requires Poisoner's Kit), Trip (1d6, DC 15 DEX), Withdraw (1d6, move half speed no OA)
- **Uncanny Dodge:** Reaction to halve one attack's damage
- **Adrenaline Rush (Orc):** Bonus-action Dash + 3 temp HP; 3 uses / Short Rest
- **Relentless Endurance (Orc):** Drop to 1 HP instead of 0, once per Long Rest
- **Darkvision 120 ft. (Orc)**
- **Feats:** Sharpshooter (+1 DEX; ranged weapon attacks ignore half and three-quarters cover; no disadvantage firing within 5 ft. of an enemy or at long range), Tavern Brawler (Enhanced Unarmed Strike 1d4+1; reroll 1s on unarmed damage; improvised weapon proficiency; Push 5 ft. once/turn), Weapon Mastery — Shortbow (Vex), Shortsword (Vex)

### Proficiencies
**Armor:** Light | **Weapons:** Crossbow, Hand, Rapier, Scimitar, Shortsword, Simple, Whip
**Tools:** Navigator's Tools, Thieves' Tools
**Languages:** Birdfolk *(not an FR language — see flag below)*, Common, Common Sign Language, Elvish, Thieves' Cant

### Equipment
Mariner's studded leather armor *(worn)*, shortsword +1, shortbow + quiver + 20 arrows, 2 daggers, thieves' tools, crowbar, rope, 1,000 ball bearings, 7 flasks of oil, hooded lantern, 10 candles, tinderbox, bell, backpack, waterskin, 5 rations. **64 lb. carried.**
