...
- **The Watcher Above:** Drow Scout — killed by Kto's longbow (~190 ft, within range) before the horn was blown. Piper assisted (6+7 damage mentioned). Full surprise maintained. *Loot: 1 hand crossbow, 1 vial drow poison.*
- **The Antechamber:** 2× Drow Scouts — killed in the surprise round. Fox killed his target (25 hit, 21+ damage); second scout also dead before acting. No alarm. *Loot: 3 hand crossbows + bolts from weapon rack; Undercommon journal from bedrolls (Zeldrazz's demoted-captain's log, reveals ritual purpose and his role as the priest's attendant).*
- **The Spider Pen:** Not entered — bypassed by ceiling-gap entry. Giant spider not encountered.
...
**Confirmed looted:**
- 1× hand crossbow + 1× vial drow poison (from watcher)
...
- 300 gp neutralize bonus (if Ending 1, 2, or 3)
...
> - DM confirmed recording sessions to feed transcripts into an AI campaign tool that tracks what happened and generates plot from it.
> - Table behavior note: session had significant off-topic chatter; DM established rules mid-session (no drug talk, no heavy sexual commentary, less "brain rot" humor). First table-rules conversation on record.
> - Update session-log.md (Campaign Arc, Recent Session pointer, Loose Ends Tracker, Foreshadowing Log) — debrief and anchor ending are both outstanding; update again after Session 4 opening.
