...
The session ends with the Herald vanishing into the Living Wood, Sela Wyndmere stepping between him and the party at the treeline, and the fey-court arc cracked open.

---

# PART ONE — Cleaning Up

*~45–60 minutes of play. This is fixed regardless of which festival plot was chosen.*

---

## Scene 1 — The Anchor Decision
...
### The Choices
The party has four options. Quillip's earlier intel (Session 003 Scene 3) and Yinu's Arcana now together give them enough to choose cleanly.

| Choice | What It Does | Cost / Note |
|---|---|---|
| **Smash** | Destroy the anchor. Definitive. AC 12, HP 40, vuln. bludgeoning. | Loud, simple. The Vhaeraunians find a shattered basalt disc — they know who did it. Brynn and Lady Ulphor read it as a strong message. |
| **Steal** | Pry the anchor out of its mount and carry it home. Yinu/Nalith can stabilize it for transport with Arcana DC 14. | The anchor goes to Orvyn for study (and quietly to the Harpers). Lady Ulphor's bonus shifts to **+200 gp**. |
| **Feed** *(Harper option)* | Leave the anchor running but slip a Harper listening-glyph into the matrix. Yinu Arcana DC 17 (with **expertise** so feasible). | Highest reward, slowest payoff. Orvyn pays **+300 gp** and starts treating the party as Harper-adjacent. **Opens a future listening session** when something speaks through it. |
| **Withdraw** | Walk away. Leave the anchor as found. | The Vhaeraunians repair it. Retaliation clock accelerates. Use only if the party is exhausted and wants the session to move. |

### Yinu Spots the Fey-Wrong
...
- Yinu loots Khelziir's silver half-mask in S3. It's still on her. Note this for Plot A's Yinu station.
- The journal Kto/Fox lifted from the antechamber bedrolls is Zeldrazz's demoted-captain's log — surface it now if the party didn't read it last session.

---

## Scene 2 — The Walk Back
...
### DM Notes
- Don't slow down. This is a montage beat, not a scene.
- If anyone asks what Greengrass is: spring festival, first night of Mirtul, flowers and bonfires, the river crossings open, the fey walk openly. Sela will be running the Greening at the wood's edge tomorrow.

---

## Scene 3 — The Ashaba House Debrief

### Setup
Lady Ulphor's solar. Late afternoon. Brynn Ashford is at her right hand with the ledger. Orvyn Tal arrives midway through (he closed the bookshop early). Captain Helm is **not** here — he's at the green, helping his militia put up the procession poles, and Lady Ulphor will tell you that with a small smile.

### Tone
**Warmer than Session 2's debrief.** Lady Ulphor has paid Captain Helm's stitches twice now to cover the party's mistakes; she has also paid them for two closed sites and what looks like a third. She is starting to think of these five children as *hers.* Brynn is sharper — he caught Kto's eye when she shifted the letter in her belt-pouch on the walk in.

### The Beats

1. **Who reports first?** Whoever the party picks. Brynn wants the technical write-up (anchor disposition, drow strength, Quillip). Orvyn wants the *meaning* (was the priest a fanatic or a contractor? Who paid him?). Lady Ulphor wants the **count of bodies and the count of secrets.** Let the kids decide the order.
...
3. **Pay.** 600 gp baseline (120 gp / PC across the 5 present — Loric absent, Naan counted). Bonuses:
   ...
   - **Withdraw:** +0; Lady Ulphor frowns but doesn't dock pay.

4. **The Festival Invitation.** Lady Ulphor's last note in the debrief: she is hosting Greengrass tomorrow and would be deeply pleased if her honored guests would stay on as her honored guests. *"You will not be charged for the Ashaba House while you are mine."* This is not a request. The kids are now stuck in Shadowdale for the festival. Good.

5. **Brynn pulls Kto aside.** As the party files out, Brynn touches Kto's elbow — only Kto's — and says, quietly enough that nobody else hears: *"I am at the bookshop on Thursday afternoons."* That's the whole conversation. He's letting her keep the letter on her own time. Move on.
...
### What This Locks In
- Party paid. Lady Ulphor's debt to the table goes from 1 to 0.
- Brynn knows Kto knows.
- Yinu has a Harper marker (only if Feed was chosen).
- The party is in Shadowdale for the next 24 hours.

---

# PART TWO — The Greengrass Greengage Affair

*~2–2.5 hours of play. Festival, then crash.*
...
- Each station is a **three-check skill challenge** with escalating DCs (13 / 15 / 17). Success ladder is the same at every station:

| Successes | Result |
|---|---|
| **3 of 3 — Gold Ribbon** | Prize + Heroic Inspiration + a personal NPC scene |
| **2 of 3 — Silver Ribbon** | Prize |
| **1 of 3 — Bronze Ribbon** | A personal NPC scene |
| **0 of 3** | Good-natured loss. The kid still gets a line. No penalty. |

- After the last station resolves, give a five-minute break — the bonfire scene is next.
...
**Host:** Captain Corwick Helm, judging.
**Co-competitor:** Rellan Tessar, back on his feet and shooting in the same heat.
**Setup:** Three floral-bobber targets drift in the Ashaba current under the Old Skull wind. Crowds on the south bank.

| # | Check | DC | Notes |
|---|---|---|---|
| 1 | Standing shot vs. anchored target | Attack vs. **AC 13** | Kto's Longbow +9 with Archery — should hit on most rolls. |
| 2 | Wind-read | **Wisdom (Perception) DC 15** | Kto's +5; competitive. Failure → the next shot is at disadvantage. |
| 3 | Moving shot vs. river-bobber | Attack vs. **AC 17** | Champion's Improved Critical (19–20) makes the sweep plausible. |

**Gold Ribbon scene:** Captain Helm walks down to the water with Kto, says "I am glad I was wrong about him" — and Kto knows he means Rellan, and also doesn't. He extends his hand. **This is the public closure of the S2 Helm rift.** Mark it.
**Bronze Ribbon scene:** Rellan claps her on the shoulder and says he owes her three arrows for the cliffside. They split a meat pie.
...
**Setup:** A raised platform under the Twilight Tower banner. Fiorn drew the closing slot (Halbren made sure).

| # | Check | DC | Notes |
|---|---|---|---|
| 1 | Opening number | **Performance DC 13** | Fiorn's +9 expertise — almost automatic. |
| 2 | Crowd-work through Halbren's heckling | **Deception DC 15** | Fiorn's +9 expertise. Halbren is whispering to the judges; Fiorn has to keep the room. |
| 3 | The closing | **Performance DC 17** | Use **Musician feat's Encouraging Song** — grants Heroic Inspiration to 3 allies after their next rest. Fox the player loves this. |

**Gold Ribbon scene:** Halbren — for one honest second — looks impressed. Then the mask slides back on and he asks where Fiorn is touring next. *He's recruiting.* Fiorn can take the bait or not.
**Bronze Ribbon scene:** Halbren wins on votes but Lady Ulphor leans over the judges' table afterward and tells Fiorn quietly that her vote went to him. That's the prize.

---

### Station C — Orvyn's "Wonders of Spring" Arcane Stall *(Yinu)*

**Host:** Orvyn Tal, quietly judging.
**Setup:** Three mystery items donated by villagers, identified live for the crowd.

| # | Check | DC | The Item | Notes |
|---|---|---|---|---|
| 1 | A fey-touched primrose | **Arcana DC 13** | Yinu's +11 expertise. | Real answer: a primrose that grew through a Feywild seam. Harmless. |
| 2 | A river stone with a faint inscription | **Investigation DC 15** | Yinu's +8. | **Plant.** It is a *partial Lolthite signal-stone* — half of a paired comm device. The other half is in the Underdark. Foreshadowing the wider drow war. |
| 3 | A vial of "spring tonic" sold by an outlander stranger | **Arcana or Alchemist's Supplies DC 17** | Yinu's +11/+? — should hit with expertise. | **Plant.** It is a *Vhaeraunian numbing draught.* Whoever sold it is on the green right now. The signal stone is the bait; the draught is the receipt. |
...
### Station E — The Greening of the Beasts *(Nalith)*

**Host:** Sela Wyndmere, assisting in the open. **Quillip Burr-and-Whistle**, invisibly watching.
**Setup:** Living Wood's edge. Canon Greengrass druid observance — flower offerings, blessings of spring animals, a small altar of stacked river-stone.

| # | Check | DC | Notes |
|---|---|---|---|
| 1 | Prepare the blessing posy | **Herbalism Kit DC 13** | Nalith's Herbalism prof + WIS. |
| 2 | Call the animals with a wood instrument | **Performance DC 15** | Musician feat (Birdpipes/Flute) — strong. |
| 3 | Settle a skittish doe in front of the crowd | **Animal Handling DC 17** | Nalith's +6 — needs a roll. |
...
### Beats
- **Ribbon ceremony** (~5 min) — read out who won what. Hand out Heroic Inspiration to every Gold Ribbon PC.
...
**Initiative is not yet rolled.** Cut here for the next scene.
...
The Antlered Herald, **Lorindar Greenmantle**, rides out of the Living Wood on his stag **Erith-of-the-First-Snow**. Two **sprite outriders** circle high above on fey-touched owls. He raises a long-staff topped with the unnamed fey lord's standard — a white branch crowned in iron antler, hung with three ribbons of green, white, and bone.
...
### The Trigger
Sela Wyndmere wears a courier ribbon on her belt — bone-and-green stitched in a knot only the unnamed fey lord's couriers carry. **Fiorn (Passive Perception 12) or Yinu (Passive Perception 15) will recognize the standard's ribbons as the same as the courier-knot on Sela's belt** if they're looking at the standard at all.

- **If a PC names it aloud** — *"Sela's ribbon!"* or similar — Sela goes ash-white and freezes. The kids' guess will be: *the lord who's been using Sela without her consent has just shown up.*
...
### Combat Shape (full detail in file 2)
- **1 named antagonist** — Lorindar Greenmantle, the Antlered Herald (CR 5 fey)
...
- **The unnamed fey lord** is now named (sort of — "the Bright Court Beneath," the lord's title still TBD).
- **Sela Wyndmere's "consultations"** have a face now. The party will have questions.
- **Quillip's silence** about Sela's fey lord in S3 — explained. She knew him. She was warning Nalith with the hawthorn berry.
- **The audience invitation** — at the next full moon, hawthorn-cleft of his choosing. **Mark for S5 or S6.**

---

## Scene 8 — The Aftermath (the last 15 minutes of play)

### Setup
The Herald is gone. The stag's hoofprints in the river-mud are filling with white blossom. The sprites are nowhere. The bonfire is still standing — Lady Ulphor never dropped the brand. The crowd is murmuring and starting to leave.

### Beats
- **Sela Wyndmere walks up.** She is shaking. She tells the party, plainly and without preamble: *"He has been using me. I knew. I didn't know how to say it."* This is the **opening of the Sela arc** — her courier work, the messages she doesn't read, the lord she's been carrying for.
- **Lady Ulphor crosses to the party.** Quiet. *"You will tell me everything tomorrow. Tonight we light the fire."* And she does. The flame catches. The crowd cheers anyway.
- **Brynn Ashford pulls Kto aside again.** Same line: *"Thursday afternoons."*
- **Orvyn Tal pulls Yinu aside.** *"That stall was not an accident. The river stone, the tonic, this. The Harpers have been waiting for you for two years."*
- **Halbren Vass tips his hat to Fiorn from the crowd, then is gone.** Mark for S5+.
- **Quillip appears at Nalith's elbow.** *"I'll be at the hawthorn at quarter-moon. Bring four friends. Not five."* She gives Nalith a real wink. (This is the **chained Plot B hook** for a future session.)

### End of Session
Cut on Lady Ulphor's bonfire roaring up against the dusk and the party standing in front of it with ribbons pinned, level 6, and a fey lord on their dance card.
...
### Magic Items / Boons
- **Encouraging Song** post-Bardic Showcase (Fiorn Musician feat) — Heroic Inspiration to 3 allies after rest. Standard feat use; no new item.
- **Khelziir's silver half-mask** (Yinu's loot from S3) — keep on Yinu. Plot-significant later. Treat as a sentimental item for now.
- **River-stone signal fragment** (Yinu, if she earned Station C Bronze+) — Lolthite paired comm half. Useless on its own. Plot bait.
- **Vial of "spring tonic"** (Yinu, if she identified it) — 2 doses of Vhaeraunian numbing draught. Mechanically: as *poison, basic (Drow)* but on a CON save DC 13, target is poisoned for 1 hr instead of unconscious.
- **Dried hawthorn berry** (Nalith) — fey gift. Plant in soil at quarter-moon and it grows into a hawthorn that always blooms two weeks early. Cosmetic. Lovely.
- **Harper primer book** (Yinu, if she earned Station C Gold OR if Feed was chosen) — *Cypher and Glyph-Sign in the Northern Sword Coast.* No price tag. Subtle Harper recruitment.

### XP / Milestone
- **Level 6** at debrief. Milestone, not XP. *(See party.md once edited to reflect L6.)*
